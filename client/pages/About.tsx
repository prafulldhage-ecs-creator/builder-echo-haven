    ...
    <div className="space-y-20 pb-24">
          ...
          <div className="mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            >
              <span className="inline-flex items-center gap-2 rounded-full border border-border/60 bg-background/60 px-3 py-1 text-xs uppercase tracking-[0.28em] text-muted-foreground backdrop-blur">
                <Sparkles className="size-3.5 text-brand" /> Story-first
                designer & technologist
              </span>
              <h1 className="text-balance text-4xl font-extrabold tracking-tight sm:text-5xl">
                Designing immersive, future-ready experiences that connect
                people to possibilities
              </h1>
              <div className="space-y-4 text-sm text-muted-foreground leading-relaxed">
                <p>
                  Hey there 👋 I’m Prafull Dhage, a UI/UX Designer, Web
                  Developer, and GDGC Committee Member currently pursuing my
                  B.E. in Electronics & Computer Science at Atharva College of
                  Engineering.
                </p>
                <p>
                  I’m passionate about experiences that blend design and
                  technology. As the Webmaster Assistant Head for IEEE
                  Techithon, I guide event platforms end-to-end — managing
                  content, crafting UI flows, and launching real-time updates.
                </p>
                <p>
                  I’m exploring Python and deepening my web framework expertise
                  while producing polished narratives through CapCut and Adobe
                  Premiere Pro. My team is also prototyping a CPLD-Based Gas
                  Leakage Detector, merging safety innovation with responsive
                  dashboards.
                </p>
              </div>
            ...
            >
              <div
                className="absolute -inset-8 rounded-[3rem] bg-[conic-gradient(from_180deg,theme(colors.brand),#7c3aed,#38bdf8,theme(colors.brand))] opacity-30 blur-3xl"
                aria-hidden
              />
              <div className="relative rounded-[2.5rem] border border-border/60 bg-background/70 p-6 backdrop-blur-xl">
                <div className="rounded-[2rem] border border-border/60 bg-background/70 p-5">
                  ...
                  <div className="mt-4 rounded-xl border border-border/60 bg-background/70 p-4 text-sm text-muted-foreground">
                    ...
                    <p className="mt-1">
                      CPLD-Based Gas Leakage Detector — real-time alerts,
                      hardware dashboards, and safety-first UX.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Each project balances research-backed UX, futuristic aesthetics,
              and dependable engineering to deliver narratives that feel alive.
            </p>
            <div className="grid gap-4 sm:grid-cols-2">
              {expertise.map((item) => (
                ...
                >
                  <div
                    aria-hidden
                    className="pointer-events-none absolute -top-16 -right-16 h-32 w-32 rounded-full bg-gradient-to-br from-brand/30 via-fuchsia-500/10 to-cyan-400/10 blur-3xl group-hover:from-brand/45 transition"
                  />
          ...
          >
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Continuously refined through hackathons, GDGC initiatives,
              freelance collabs, and design sprints.
            </p>
      ...
      <section className="container">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Guided by curiosity, mentorship, and hands-on experimentation across
            campus communities.
          </p>
        ...
        <div className="mx-auto max-w-5xl rounded-2xl border border-border/60 bg-background/60 p-6 backdrop-blur">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Concentrated overview covering academics, project leadership,
        ...
        <div className="mx-auto max-w-5xl rounded-2xl border border-border/60 bg-background/60 p-6 backdrop-blur">
          <div className="grid gap-6 md:grid-cols-[0.95fr_1.05fr]">
            <div>
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Open to internships, collaborations, and UI/UX audits. Reach out
                with your ideas — let’s build something futuristic together.
              </p>
            ...
            >
              ...
              <Button
                type="submit"
                className="bg-gradient-to-r from-brand via-fuchsia-500 to-cyan-400 text-white"
              >
                Send message
              </Button>
            </motion.form>
